...
def Post_List_View(request,tag_slug=None):
    ...
    paginator=Paginator(post_list,3)#created paginator object
    page_number=request.GET.get('page')#current page
    try:
        post_list=paginator.page(page_number)#how many post to display per page
...
def post_detail_view(request,year,month,day,post):
    ...
    if request.method=='POST':
        ...
        'comments':comments,'csubmit':csubmit,'similar_posts':similar_posts,})
